            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div><strong>SPG Product Applications:</strong> Table of ongoing SPG prequalifications. FIS acts as coordinator while technical tests can be handled by existing units.</div>
                    </div>
                )}
            </div>
