            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '8px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div><strong>Roles Overview (Roles):</strong> Shows all registered actors and their roles.</div>
                        <div><strong>Actor Details (Click name):</strong> Split into sections per role.</div>
                        <div><strong>Role-subsets:</strong> Filtered views of the overview for CURR, SP, BSP, DSO, RE, and BRP.</div>
                    </div>
                )}
            </div>
