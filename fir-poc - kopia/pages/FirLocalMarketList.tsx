      ...
      <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
        ...
        {isHowToExpanded && (
          <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
            <div><strong>Local Markets (Click the market name):</strong> Information about registered local markets.</div>
            <div><strong>Details:</strong> Introduction, possible products, number of available CUs/volume, and grid areas.</div>
          </div>
        )}
      </div>
