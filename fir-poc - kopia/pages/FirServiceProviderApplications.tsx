            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div><strong>Service Provider Applications:</strong> FIS coordinates and tracks status for SP applications. Administrative handling can be managed externally (for example, SEEA) using information from FIS.</div>
                    </div>
                )}
            </div>
