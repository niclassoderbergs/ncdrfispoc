            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div>Local Flex Settlement (DSO): Summarizes volumes from verified DSO bids per SP. Sent to the DSO; FIS verifies these for correct imbalance adjustment and compensation.</div>
                    </div>
                )}
            </div>
