            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div><strong>Two tables are shown:</strong></div>
                        <div>The top table shows registered CUs that have active flexibility agreements with an SP.</div>
                        <div>The bottom table shows CUs that do not yet have an agreement.</div>
                    </div>
                )}
            </div>
