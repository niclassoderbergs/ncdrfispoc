      ...
      <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
        ...
        {isHowToExpanded && (
          <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
            <div><strong>Constituent Resources (CUs):</strong> Shows included CUs and whether meter values from CU or metering point (MP) are used for baseline.</div>
            <div><strong>Meter Value Status:</strong> Indicates whether meter values are available for verification.</div>
            <div><strong>Verified MWh:</strong> Used for imbalance adjustment and electricity supplier compensation.</div>
          </div>
        )}
      </div>
