            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div>Two tables show bids for the TSO and DSO markets.</div>
                        <div>Bids are received by the TSO/DSO bid intake systems and can be forwarded to FIS for validation.</div>
                        <div>FIS compares bid volume against the SPG's available capacity based on included CUs and temporary grid constraints.</div>
                        <div>Rule-based checks ensure that a CU is not already selected for another activation.</div>
                        <div>The validation result is returned to the TSO/DSO.</div>
                    </div>
                )}
            </div>
