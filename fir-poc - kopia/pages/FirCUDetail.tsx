  ...
  return (
    <div style={pocStyles.content}>
        ...
        <div style={{...pocStyles.section, backgroundColor: '#f8fafd'}}>
            ...
            {isHowToExpanded && (
                <>
                    <p style={{fontSize: '0.9rem', color: '#42526e', lineHeight: '1.6', marginTop: '16px'}}>
                        The page is divided into the following sections:
                    </p>
                    <div style={{display: 'grid', gap: '10px', fontSize: '0.88rem', color: '#172b4d', lineHeight: '1.55'}}>
                        <div><strong>Operational Alerts & Current Constraints</strong><br />Shows active or upcoming temporary grid constraints registered by the grid owner.</div>
                        <div><strong>Overview</strong><br />Selected statuses such as flexibility agreement, grid prequalification, TSO SPG, and DSO SPG.</div>
                        <div><strong>Market Product Qualifications</strong><br />Qualified products for the SPG that the CU belongs to.</div>
                        <div><strong>DHV Relations</strong><br />Shows relationships for the underlying metering point/facility (from the data handling tool). Used for correct imbalance adjustment and compensation. Updated automatically when the delivery structure changes, for example when switching electricity supplier.</div>
                        <div><strong>Flexibility Relations</strong><br />Shows CURR (the party that registered the resource) and SP (the party holding the flexibility agreement). Personal/organization ID is used to verify that this is the same customer across grid, energy supply, and flexibility agreements.</div>
                        <div><strong>Technical Identity & Base Qualification</strong><br />Technical properties for the CU and underlying metering point/facility (retrieved from DHV).</div>
                        <div><strong>Baseline & Compliance</strong><br />Qualified products for the CU’s SPG and which baseline methods the SP selected for each product.</div>
                        <div><strong>Recent Verifications (Ex-post)</strong><br />Shows the most recent activated bids in which the CU participated.</div>
                        <div><strong>Relationship History</strong><br />History of DHV and Flexibility relationships. Used for traceability and correct corrections/adjustments.</div>
                    </div>
                </>
            )}
        </div>
