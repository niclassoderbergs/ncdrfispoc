...
import { Zap, Search, Filter, Globe, ChevronLeft, ChevronRight, Briefcase, TowerControl, UserPlus, ShieldCheck, FileText, ChevronDown, ChevronUp } from 'lucide-react';
            ...
            <div style={{...pocStyles.section, backgroundColor: '#f8fafd', marginBottom: '16px'}}>
                ...
                {isHowToExpanded && (
                    <div style={{display: 'grid', gap: '6px', fontSize: '0.9rem', color: '#172b4d', lineHeight: '1.55', marginTop: '14px'}}>
                        <div>This page is a filtered subset of <strong>Global Parties Overview</strong> and shows only actors that have the <strong>Retail Entity (RE)</strong> role.</div>
                        <div><strong>Company Name:</strong> Legal entity name. Click the name to open party details.</div>
                        <div><strong>Identified Roles:</strong> All detected roles for the same actor.</div>
                        <div><strong>RE Code:</strong> Retail entity identifier used in market and settlement contexts.</div>
                        <div><strong>Main BRP:</strong> Primary Balance Responsible Party linked to the retail entity.</div>
